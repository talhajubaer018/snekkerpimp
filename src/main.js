...
// fa solid
import { faSearch, faShoppingBag, faLongArrowAltLeft, faLongArrowAltRight, faArrowCircleRight, faCircle, faMinus, faPlus } from '@fortawesome/free-solid-svg-icons'
library.add(faFacebookF, faInstagram, faSearch, faHeart, faShoppingBag,
  ...
  faCcVisa, faCcMastercard, faCcAmex, faCircle, faMinus, faPlus)
